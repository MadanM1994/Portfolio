    ...
    <div>
      <div className="container-project">
        <div className="project-details">
          ...
          <p>
            <strong>Duration:</strong> JANUARY 2017 - JUNE 2020
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              ensure the platform met scalability requirements.
            </li>
            <li>
              Assisted in the deployment of the platform on AWS, and provided
              ongoing support as needed.
            </li>
            <li>
              Collaborated with the marketing team to promote the platform and
            ...
            <li>
              Conducted A/B testing to optimize user engagement and retention,
            ...
            <li>
              ...
              authentication, and deployment, enhancing the platform's
          ...
          <ul>
            ...
            <li>
              Conducted usability testing and implemented user feedback to
            ...
            <li>
              Worked with the development team to ensure the website met
              industry standards for security and compliance.
            </li>
            <li>
              Provided training to the editorial team on how to use the content
            ...
            <li>
              Integrated GraphQL to optimize the website's data fetching
              capabilities and improve its performance.
            </li>
            <li>
              Improved the website's SEO and loading speed by implementing
          ...
          <ul>
            ...
            <li>
              ...
              the company's existing HR systems.
            </li>
            <li>
              Provided ongoing maintenance and support for the job board,
            ...
            <li>
              Integrated Google Maps API to provide location-based job searching
            ...
            <li>
              Enhanced the job board's data fetching capabilities using GraphQL
              and Apollo.
            </li>
            <li>

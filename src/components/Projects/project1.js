    ...
    <div>
      <div className="container-project">
        <div className="project-details">
          ...
          <ul>
            <li>
              Collaborate with a team to develop UI layout and front-end
              programming for web applications using various phases of the
              Software Development Life Cycle, such as requirements analysis,
            ...
            <li>
              ...
              developing test plans and strategies and identifying and
            ...
            <li>
              ...
              JavaScript development, including new language features and
              libraries.
            </li>
            <li>
